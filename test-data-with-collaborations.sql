...
SELECT 'Users created:' as info, COUNT(*) as count FROM users WHERE id::text LIKE '11111111%' OR id::text LIKE '22222222%' OR id::text LIKE '33333333%' OR id::text LIKE '44444444%' OR id::text LIKE '55555555%' OR id::text LIKE '66666666%' OR id::text LIKE '77777777%' OR id::text LIKE '88888888%'
UNION ALL
SELECT 'Restaurants created:', COUNT(*) FROM restaurants WHERE id::text LIKE '11111111-aaaa%' OR id::text LIKE '22222222-bbbb%' OR id::text LIKE '33333333-cccc%' OR id::text LIKE '44444444-dddd%' OR id::text LIKE '55555555-eeee%' OR id::text LIKE '66666666-ffff%' OR id::text LIKE '77777777-aaaa%' OR id::text LIKE '88888888-bbbb%' OR id::text LIKE '99999999-cccc%' OR id::text LIKE 'aaaaaaaa-dddd%'
UNION ALL
SELECT 'Collections created:', COUNT(*) FROM collections WHERE id::text LIKE 'aaaaaaaa-bbbb%' OR id::text LIKE 'bbbbbbbb-cccc%' OR id::text LIKE 'cccccccc-dddd%' OR id::text LIKE 'dddddddd-eeee%' OR id::text LIKE 'eeeeeeee-ffff%'
UNION ALL
SELECT 'Collection members:', COUNT(*) FROM collection_members WHERE id::text LIKE 'aaaaaaaa-aaaa%' OR id::text LIKE 'bbbbbbbb-bbbb%' OR id::text LIKE 'cccccccc-cccc%' OR id::text LIKE 'dddddddd-dddd%' OR id::text LIKE 'eeeeeeee-eeee%' OR id::text LIKE 'ffffffff-ffff%' OR id::text LIKE '11111111-aaaa%' OR id::text LIKE '22222222-bbbb%' OR id::text LIKE '33333333-cccc%' OR id::text LIKE '44444444-dddd%' OR id::text LIKE '55555555-eeee%' OR id::text LIKE '66666666-ffff%' OR id::text LIKE '77777777-aaaa%' OR id::text LIKE '88888888-bbbb%' OR id::text LIKE '99999999-cccc%' OR id::text LIKE 'aaaaaaaa-dddd%' OR id::text LIKE 'bbbbbbbb-eeee%' OR id::text LIKE 'cccccccc-ffff%' OR id::text LIKE 'dddddddd-aaaa%' OR id::text LIKE 'eeeeeeee-bbbb%' OR id::text LIKE 'ffffffff-cccc%' OR id::text LIKE '11111111-dddd%' OR id::text LIKE '22222222-eeee%' OR id::text LIKE '33333333-ffff%'
UNION ALL
SELECT 'Restaurant votes:', COUNT(*) FROM restaurant_votes WHERE id::text LIKE 'aaaaaaaa-1111%' OR id::text LIKE 'bbbbbbbb-2222%' OR id::text LIKE 'cccccccc-3333%' OR id::text LIKE 'dddddddd-4444%' OR id::text LIKE 'eeeeeeee-5555%' OR id::text LIKE 'ffffffff-6666%' OR id::text LIKE '11111111-7777%' OR id::text LIKE '22222222-8888%' OR id::text LIKE '33333333-9999%' OR id::text LIKE '44444444-aaaa%' OR id::text LIKE '55555555-bbbb%' OR id::text LIKE '66666666-cccc%' OR id::text LIKE '77777777-dddd%' OR id::text LIKE '88888888-eeee%' OR id::text LIKE '99999999-ffff%' OR id::text LIKE 'aaaaaaaa-1111%' OR id::text LIKE 'bbbbbbbb-2222%' OR id::text LIKE 'cccccccc-3333%' OR id::text LIKE 'dddddddd-4444%' OR id::text LIKE 'eeeeeeee-5555%' OR id::text LIKE 'ffffffff-6666%' OR id::text LIKE '11111111-7777%' OR id::text LIKE '22222222-8888%' OR id::text LIKE '33333333-9999%' OR id::text LIKE '44444444-aaaa%' OR id::text LIKE '55555555-bbbb%' OR id::text LIKE '66666666-cccc%' OR id::text LIKE '77777777-dddd%'
UNION ALL
SELECT 'Discussions created:', COUNT(*) FROM restaurant_discussions WHERE id::text LIKE 'aaaaaaaa-aaaa%' OR id::text LIKE 'bbbbbbbb-bbbb%' OR id::text LIKE 'cccccccc-cccc%' OR id::text LIKE 'dddddddd-dddd%' OR id::text LIKE 'eeeeeeee-eeee%' OR id::text LIKE 'ffffffff-ffff%' OR id::text LIKE '11111111-aaaa%'
UNION ALL
SELECT 'User activities:', COUNT(*) FROM user_activities WHERE id::text LIKE '22222222-bbbb%' OR id::text LIKE '33333333-cccc%' OR id::text LIKE '44444444-dddd%' OR id::text LIKE '55555555-eeee%' OR id::text LIKE '66666666-ffff%' OR id::text LIKE '77777777-aaaa%' OR id::text LIKE '88888888-bbbb%' OR id::text LIKE '99999999-cccc%';
