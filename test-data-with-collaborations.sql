...
('vote-001', 'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa', '11111111-1111-1111-1111-111111111111', 'coll-001', 'like', NOW() - INTERVAL '2 days', 'Perfect for special occasions', 'admin', 1),
('vote-002', 'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa', '22222222-2222-2222-2222-222222222222', 'coll-001', 'like', NOW() - INTERVAL '2 days', 'Amazing seafood and service', 'regular', 1),
('vote-003', 'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa', '33333333-3333-3333-3333-333333333333', 'coll-001', 'like', NOW() - INTERVAL '1 day', 'Romantic atmosphere', 'regular', 1),
('vote-004', 'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa', '44444444-4444-4444-4444-444444444444', 'coll-001', 'dislike', NOW() - INTERVAL '1 day', 'Too expensive for regular dates', 'regular', 1),

('vote-005', 'bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb', '11111111-1111-1111-1111-111111111111', 'coll-001', 'like', NOW() - INTERVAL '3 days', 'Stunning views and food', 'admin', 1),
('vote-006', 'bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb', '22222222-2222-2222-2222-222222222222', 'coll-001', 'like', NOW() - INTERVAL '3 days', 'Worth every penny', 'regular', 1),
('vote-007', 'bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb', '33333333-3333-3333-3333-333333333333', 'coll-001', 'like', NOW() - INTERVAL '2 days', 'Perfect for anniversaries', 'regular', 1),
('vote-008', 'bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb', '44444444-4444-4444-4444-444444444444', 'coll-001', 'like', NOW() - INTERVAL '2 days', 'Exceptional experience', 'regular', 1),

-- Business Lunch Spots votes (showing debate)
('vote-009', 'eeeeeeee-eeee-eeee-eeee-eeeeeeeeeeee', '22222222-2222-2222-2222-222222222222', 'coll-002', 'like', NOW() - INTERVAL '1 day', 'Perfect for client meetings', 'admin', 1),
('vote-010', 'eeeeeeee-eeee-eeee-eeee-eeeeeeeeeeee', '11111111-1111-1111-1111-111111111111', 'coll-002', 'like', NOW() - INTERVAL '1 day', 'Professional atmosphere', 'regular', 1),
('vote-011', 'eeeeeeee-eeee-eeee-eeee-eeeeeeeeeeee', '55555555-5555-5555-5555-555555555555', 'coll-002', 'dislike', NOW() - INTERVAL '1 day', 'Too casual for business', 'regular', 1),
('vote-012', 'eeeeeeee-eeee-eeee-eeee-eeeeeeeeeeee', '66666666-6666-6666-6666-666666666666', 'coll-002', 'like', NOW() - INTERVAL '1 day', 'Great food and service', 'regular', 1),
('vote-013', 'eeeeeeee-eeee-eeee-eeee-eeeeeeeeeeee', '77777777-7777-7777-7777-777777777777', 'coll-002', 'like', NOW() - INTERVAL '1 day', 'Reliable choice', 'regular', 1),

-- Foodie Adventures votes (showing diverse opinions)
('vote-014', 'cccccccc-cccc-cccc-cccc-cccccccccccc', '33333333-3333-3333-3333-333333333333', 'coll-003', 'like', NOW() - INTERVAL '2 days', 'Revolutionary plant-based cuisine', 'admin', 1),
('vote-015', 'cccccccc-cccc-cccc-cccc-cccccccccccc', '11111111-1111-1111-1111-111111111111', 'coll-003', 'like', NOW() - INTERVAL '2 days', 'Innovative and delicious', 'regular', 1),
('vote-016', 'cccccccc-cccc-cccc-cccc-cccccccccccc', '22222222-2222-2222-2222-222222222222', 'coll-003', 'dislike', NOW() - INTERVAL '2 days', 'Too experimental for my taste', 'regular', 1),
('vote-017', 'cccccccc-cccc-cccc-cccc-cccccccccccc', '44444444-4444-4444-4444-444444444444', 'coll-003', 'like', NOW() - INTERVAL '1 day', 'Amazing creativity', 'regular', 1),
('vote-018', 'cccccccc-cccc-cccc-cccc-cccccccccccc', '55555555-5555-5555-5555-555555555555', 'coll-003', 'like', NOW() - INTERVAL '1 day', 'Must-try experience', 'regular', 1),
('vote-019', 'cccccccc-cccc-cccc-cccc-cccccccccccc', '88888888-8888-8888-8888-888888888888', 'coll-003', 'dislike', NOW() - INTERVAL '1 day', 'Not worth the price', 'regular', 1),

-- Budget Eats votes (showing agreement)
('vote-020', 'hhhhhhhh-hhhh-hhhh-hhhh-hhhhhhhhhhhh', '44444444-4444-4444-4444-444444444444', 'coll-004', 'like', NOW() - INTERVAL '1 day', 'Best pastrami in NYC', 'admin', 1),
('vote-021', 'hhhhhhhh-hhhh-hhhh-hhhh-hhhhhhhhhhhh', '11111111-1111-1111-1111-111111111111', 'coll-004', 'like', NOW() - INTERVAL '1 day', 'Classic NYC experience', 'regular', 1),
('vote-022', 'hhhhhhhh-hhhh-hhhh-hhhh-hhhhhhhhhhhh', '22222222-2222-2222-2222-222222222222', 'coll-004', 'like', NOW() - INTERVAL '1 day', 'Great value for money', 'regular', 1),
('vote-023', 'hhhhhhhh-hhhh-hhhh-hhhh-hhhhhhhhhhhh', '77777777-7777-7777-7777-777777777777', 'coll-004', 'like', NOW() - INTERVAL '1 day', 'Authentic deli experience', 'regular', 1),

-- Celebrity Chef Spots votes (showing mixed opinions)
('vote-024', 'ffffffff-ffff-ffff-ffff-ffffffffffff', '55555555-5555-5555-5555-555555555555', 'coll-005', 'like', NOW() - INTERVAL '2 days', 'Batali''s best restaurant', 'admin', 1),
('vote-025', 'ffffffff-ffff-ffff-ffff-ffffffffffff', '11111111-1111-1111-1111-111111111111', 'coll-005', 'like', NOW() - INTERVAL '2 days', 'Authentic Italian cuisine', 'regular', 1),
('vote-026', 'ffffffff-ffff-ffff-ffff-ffffffffffff', '33333333-3333-3333-3333-333333333333', 'coll-005', 'dislike', NOW() - INTERVAL '2 days', 'Overrated and expensive', 'regular', 1),
('vote-027', 'ffffffff-ffff-ffff-ffff-ffffffffffff', '66666666-6666-6666-6666-666666666666', 'coll-005', 'like', NOW() - INTERVAL '1 day', 'Great pasta dishes', 'regular', 1),
('vote-028', 'ffffffff-ffff-ffff-ffff-ffffffffffff', '88888888-8888-8888-8888-888888888888', 'coll-005', 'dislike', NOW() - INTERVAL '1 day', 'Too crowded and noisy', 'regular', 1);
...
('disc-001', 'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa', 'coll-001', '11111111-1111-1111-1111-111111111111', 'Has anyone tried their tasting menu? Worth the splurge?', NOW() - INTERVAL '2 days', 3),
('disc-002', 'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa', 'coll-001', '22222222-2222-2222-2222-222222222222', 'The wine pairing is incredible! Highly recommend.', NOW() - INTERVAL '2 days', 2),
('disc-003', 'bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb', 'coll-001', '33333333-3333-3333-3333-333333333333', 'Perfect for anniversary dinners. The service is impeccable.', NOW() - INTERVAL '3 days', 4),
('disc-004', 'eeeeeeee-eeee-eeee-eeee-eeeeeeeeeeee', 'coll-002', '22222222-2222-2222-2222-222222222222', 'Great for client lunches. Professional but not stuffy.', NOW() - INTERVAL '1 day', 2),
('disc-005', 'cccccccc-cccc-cccc-cccc-cccccccccccc', 'coll-003', '33333333-3333-3333-3333-333333333333', 'The plant-based menu is revolutionary! Must try.', NOW() - INTERVAL '2 days', 5),
('disc-006', 'hhhhhhhh-hhhh-hhhh-hhhh-hhhhhhhhhhhh', 'coll-004', '44444444-4444-4444-4444-444444444444', 'Best pastrami sandwich in the city!', NOW() - INTERVAL '1 day', 3),
('disc-007', 'ffffffff-ffff-ffff-ffff-ffffffffffff', 'coll-005', '55555555-5555-5555-5555-555555555555', 'The pasta tasting menu is amazing!', NOW() - INTERVAL '2 days', 2);
...
('act-002', '22222222-2222-2222-2222-222222222222', 'vote', 'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa', 'coll-001', 'Liked Le Bernardin', NOW() - INTERVAL '2 days'),
('act-003', '33333333-3333-3333-3333-333333333333', 'discussion', 'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa', 'coll-001', 'Started discussion about tasting menu', NOW() - INTERVAL '2 days'),
('act-004', '44444444-4444-4444-4444-444444444444', 'vote', 'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa', 'coll-001', 'Disliked Le Bernardin (too expensive)', NOW() - INTERVAL '1 day'),
