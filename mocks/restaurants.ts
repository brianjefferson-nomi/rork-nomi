...
export const mockCollections: Collection[] = [
  ...
  {
    id: 'c3',
    collection_code: 'CHEAPC',
    name: 'Cheap & Cheerful 💰',
    description: "Great food that won't break the bank",
    cover_image: 'https://images.unsplash.com/photo-1555126634-323283e090fa?w=800',
    created_by: 'user2',
    creator_id: 'user2',
    is_public: true,
    likes: 32,
